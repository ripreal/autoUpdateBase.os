...
Процедура ЗавершитьСеансыИУстановитьБлокировку()
    ...
    ПараметрыАдминистрирования.АдресАгентаСервера = "srvapp1ctst00";
